...
export default (self, api) => {
  ...
  api = Object.assign(api || {}, {
    xRange: {
       ...
       * @param {number} [extend = 0] Scaling factor to extend the lower boundary with. If not zero, the lower boundary
       * is extended with the specified fraction of the entire X domain of the real plot area.
