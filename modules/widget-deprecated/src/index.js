...
export default class Widget {
    ...
    /**
     * Creates the content of the tooltip. May be overridden.
     *
     * @method _tooltip
     * @methodOf Widget
     ...
     * </ul>
     * Defaults to undefined, which creates the default color scheme.
     *
     * @method colors
     * @methodOf Widget
     * @param {(string | object)} [policy] Color policy to set.
     * @returns {Widget} Reference to the widget.
     */
    colors (policy) {
        // Update color policy
     ...
     * to the widget itself. Default is no mouseover callback.
     *
     * @method mouseover
     * @methodOf Widget
     ...
     * standalone widgets such as a label, it is bound to the widget itself. Default is no mouseleave callback.
     *
     * @method mouseleave
     * @methodOf Widget
     ...
     * widgets such as a label, it is bound to the widget itself. Default is no click callback.
     *
     * @method click
     * @methodOf Widget
